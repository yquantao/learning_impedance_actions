...
class PegInHoleSequenceSplitDataset(Dataset):
    ...
    def __init__(self, data_dir, data_conf, phase, resolution=None, shuffle=True, dataset_size=-1):
        ...
        #self.dataset = h5py.File("./spirl/data/peg_in_hole/src/peg_in_hole_dataset.hdf5", 'r')
        ...
        if 'filter_indices' in self.spec:
            print("!!! Filtering peg-in-hole demos in range {} !!!".format(self.spec.filter_indices))
